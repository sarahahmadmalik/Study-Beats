    ...
    >
      <div className="inner">
        ...
        <div className="scrollable">
          <div className="card">
            <h5>{user ? `Hi ${user?.name}` : "Welcome to Study Beats"}</h5>

            <p>{ !user ? `Welcome to the app that will enhance and change your life and productivity` : "Listen to your favourite genres and create unlimited playlists."}</p>
          ...
          <div className="actions">
            ...
            >
              <span>
                <Disc width={"16px"} height={"16px"} color={"#27bfc7"} />
              </span>
              Discover
            </button>
            <button
              ...
              onClick={() => {
                navigate("/search/genres");
              }}
            >
              <span>
                <MusicIcon width={"16px"} height={"16px"} color={"#27bfc7"} />
              </span>
              Genres
            </button>
            <button
            ...
            >
              <span>
                <Mic width={"16px"} height={"16px"} color={"#27bfc7"} />
              </span>
              Artists
            </button>
            <button
            ...
            >
              <span>
                <List width={"16px"} height={"16px"} color={"#27bfc7"} />
              </span>
              Library
            </button>
            ...
            >
              <span>
                <Expand width={"16px"} height={"16px"} color={"#27bfc7"} />
              </span>
              <span
                data-for="fullScreen"
                ref={(elem) => {
